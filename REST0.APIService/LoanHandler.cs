...
<html lang=""en""><head><title>Loan Calculator</title><meta http-equiv=""Content-Type"" content=""text/html; charset=utf-8""><link href=""imgs/style.css"" rel=""stylesheet"" type=""text/css""></head><body><h2>Dear ");
                ...
                reply.Append(@"<br><table class=""clean"" width=240px><tr><th>loan</th><th>details</th></tr>");
                ...
                reply.AppendFormat(@"<tr class=""d0""><td>Cost</td><td>{0:n}", cost);
                reply.AppendFormat(@" ({0:n}%)</td></tr></table>", 100 / (amount / cost));

                reply.Append(@"<br><table class=""clean"" width=112px>");
                reply.AppendFormat(@"<tr class=""d1""><td><b>YEAR {0:d}</b>", year);

                reply.Append(@"</td></tr></table><table class=""clean"" width=550px><tr><th>month</th><th>payment</th><th>interest</th><th>principal</th><th>balance</th></tr>");
                ...
                for (; ; ) // output monthly payments
                {
                    ...
                    reply.AppendFormat(@"<td>{0}</td>", Months[month - 1]);
                    ...
                    if (month == 12)
                    {
                        if (amount > 0)
                        {
                            ...
                            reply.AppendFormat(@"<tr class=""d1""><td><b>YEAR {0}</b>", year);
                            reply.Append(@"</td></tr></table><table class=""clean"" width=550px><tr><th>month</th><th>payment</th><th>interest</th><th>principal</th><th>balance</th></tr>");
                        }
                        else
                            break;
                ...
                reply.AppendFormat(@"</table><br>This page was generated in {0} milliseconds. <br>(on a 3GHz CPU 1 ms = 3,000,000 cycles)<br></body></html>", elapsed.TotalMilliseconds);
